...
public class RestPathParser implements RestResultConverter {
    ...
    private Path parseFullPath(Map path, final RestAPI restApi) {
        ...
        final Map<?, ?> lastRelationshipData = lastElementFromMap(relationshipsData);
    ...
    private Path parsePath(Map path, final RestAPI restApi){
        ...
        final String lastRelationshipData = lastElementFromString(relationshipsData);
    ...
    private String lastElementFromString(Collection<String> collection){
//    private Map<?, ?> lastElement(Collection<String> collection){
       return IteratorUtil.lastOrNull(collection);
    }

    private Map<?, ?> lastElementFromMap(Collection<Map<?, ?>> collection) {
